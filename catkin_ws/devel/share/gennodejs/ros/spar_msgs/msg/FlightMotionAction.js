...
let FlightMotionActionGoal = require('./FlightMotionActionGoal.js');
let FlightMotionActionResult = require('./FlightMotionActionResult.js');
let FlightMotionActionFeedback = require('./FlightMotionActionFeedback.js');

//-----------------------------------------------------------

class FlightMotionAction {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('action_goal')) {
        ...
        this.action_goal = new FlightMotionActionGoal();
      }
      if (initObj.hasOwnProperty('action_result')) {
        this.action_result = initObj.action_result
      }
      else {
        this.action_result = new FlightMotionActionResult();
      }
      if (initObj.hasOwnProperty('action_feedback')) {
        this.action_feedback = initObj.action_feedback
      }
      else {
        this.action_feedback = new FlightMotionActionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FlightMotionActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = FlightMotionActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = FlightMotionActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FlightMotionAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = FlightMotionActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = FlightMotionActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = FlightMotionActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += FlightMotionActionGoal.getMessageSize(object.action_goal);
    length += FlightMotionActionResult.getMessageSize(object.action_result);
    length += FlightMotionActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FlightMotionAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = FlightMotionActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new FlightMotionActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = FlightMotionActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new FlightMotionActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = FlightMotionActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new FlightMotionActionFeedback()
    }
...
module.exports = FlightMotionAction;
