...
let FlightMotionFeedback = require('./FlightMotionFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class FlightMotionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new FlightMotionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FlightMotionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FlightMotionActionFeedback(null);
    ...
    data.feedback = FlightMotionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FlightMotionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = FlightMotionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new FlightMotionFeedback()
    }
...
module.exports = FlightMotionActionFeedback;
